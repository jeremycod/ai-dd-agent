export const PROMPT =
  ...
  '\n5. **Strategize Tool Use:** Based on the information gathered, the nature of the suspected issue, and the **validated environment**, determine which of your available tools are best suited for investigation (e.g., `getDatadogLogs` for log analysis, or other tools for checking configurations, publishing status, etc.).' +
